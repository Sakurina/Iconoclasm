...
@property(assign) BOOL isConnectedToUnusableFirewireCharger;
...
@property(readonly, assign) BOOL isBatteryCharging;
@property(readonly, assign) BOOL isOnAC;
@property(readonly, assign) unsigned char headsetBatteryCapacity;
@property(readonly, assign) BOOL isHeadsetDocked;
