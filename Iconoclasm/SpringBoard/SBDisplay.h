...
@property(assign) double autoDimTime;
@property(assign) double autoLockTime;
@property(assign) BOOL expectsFaceContact;
@property(assign) double accelerometerSampleInterval;
@property(assign) BOOL accelerometerDeviceOrientationChangedEventsEnabled;
...
+(id)_defaultValueForKey:(id)key applicationStateID:(id)id;
