...
@class NSMutableArray, VSRecognitionSession, VSSpeechSynthesizer, NSInvocation, NSMutableIndexSet, NSTimer, NSMutableSet, UIKeyboard, AVController, UITextField, NSDictionary, NSString;
...
-(void)_labelsFadedOut:(id)out finished:(id)finished labels:(id)labels;
