...
@class UITouch, TPLCDTextView, SBSearchView, SBIconModel, UIView, SBIconList, SBIconListPageControl, NSTimer, SBIcon, SBIconScrollView;
...
@property(retain) SBIcon *iconToInstall;
@property(assign) BOOL isEditing;
@property(retain) SBIcon *grabbedIcon;
@property(readonly, retain) UIView *contentView;
@property(readonly, assign) int currentIconListIndex;
@property(readonly, retain) SBIconList *destinationIconList;
+(id)sharedInstance;
-(id)init;
-(void)dealloc;
